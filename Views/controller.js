...
var ctxfolderWorkflowActivity = "/views/admin/workflowActivity";
var ctxfolderRQP = "/views/admin/sendRequestWorkPrice";

var app = angular.module('App_ESEIM_CONTRACT', ['App_ESEIM_DASHBOARD', 'App_ESEIM_CUSTOMER', 'App_ESEIM_PROJECT', 'App_ESEIM_CARD_JOB', 'App_ESEIM_ATTR_MANAGER', 'App_ESEIM_MATERIAL_PROD',
    'App_ESEIM_REPOSITORY', 'App_ESEIM_SUPPLIER', 'App_ESEIM_FILE_PLUGIN', 'App_ESEIM_WF_PLUGIN', 'App_ESEIM_CJ_PLUGIN',
    "ui.bootstrap", "ngRoute", "ngValidate", "datatables", "datatables.bootstrap", 'datatables.colvis', "ui.bootstrap.contextMenu", 'datatables.colreorder', 'angular-confirm', "ngJsTree",
    "treeGrid", "ui.select", "ngCookies", "pascalprecht.translate", 'ngTagsInput', 'dynamicNumber', 'ng.jsoneditor', 'ui.tab.scroll', "chart.js"]);
...
app.factory('dataserviceContract', function ($http) {
    ...
    return {
        ...
        getAllDetail: function (data, callback) {
            $http.get('/Admin/Contract/GetAllDetail?contractCode=' + data).then(callback);
        },
        ...
        updateGattrJson: function (data, callback) {
            $http.put('/Admin/Contract/UpdateGattrJson', data).then(callback);
        },
        ...
        exportExcelCalendar: function (data, callback) {
            $http.post('/Admin/Contract/ExportExcelCalendar', data).then(callback);
        },
        ...
        getActInstArranged: function (data, data1 = 'CONTRACT', callback) {
            $http.post(`/Admin/WorkflowActivity/GetActInstArranged?objInst=${data}&objType=${data1}`).then(callback)
        },
        getActInstArrangedWf: function (data, callback) {
            $http.post(`/Admin/WorkflowActivity/GetActInstArrangedWf?wfInstCode=${data}`).then(callback)
        },
        ...
        GetCompanyByGroup: function (callback) {
            $http.get('/Admin/ProductImport/GetCompanyByGroup').then(callback);
        },

        GetListUserDelivery: function (callback) {
            $http.post('/Admin/BomDelivery/GetListUserDelivery').then(callback);
        },

        getListInventoryAuditHeader: function (pageCurrent, pageLength, content, callback) {
            $http.get(`/Admin/BomDelivery/GetListProductExpHeaderNotDone?pageCurrent=${pageCurrent}&pageLength=${pageLength}&content=${content}`)
                .then(callback);
        },
        ...
        getWorkFlowByType: function (data, callback) {
            $http.get(`/Admin/WorkflowActivity/GetWorkflowByType?activityObjType=${data}`).then(callback);
        },
        ...
        insertObjectActivityInstanceNote: function (data, callback) {
            $http.post('/Admin/WorkflowActivity/InsertObjectActivityInstanceNote', data).then(callback)
        },
        updateObjectActivityInstanceNote: function (data, callback) {
            $http.put('/Admin/WorkflowActivity/UpdateObjectActivityInstanceNote', data).then(callback)
        },
        updateObjectActivityInstanceView: function (data, callback) {
            $http.put('/Admin/WorkflowActivity/UpdateObjectActivityInstanceView', data).then(callback)
        },
        getObjectActivityInstanceNote: function (data, callback) {
            $http.get('/Admin/WorkflowActivity/GetObjectActivityInstanceNote?id=' + data).then(callback);
        },
        ...
        // workflow act obj dt
        getWorkflowObjectAct: function (objectCode, objectType, callback) {
            $http.get(`/Admin/WorkflowActivity/GetWorkflowObjectAct?objectCode=${objectCode}&objectType=${objectType}`).then(callback);
        },
        checkWorkflowObjectHeader: function (objectCode, objectType, callback) {
            $http.get(`/Admin/WorkflowActivity/CheckWorkflowObjectHeader?objectCode=${objectCode}&objectType=${objectType}`).then(callback);
        },
        getWorkflowObjectDetail: function (objectCode, objectType, callback) {
            $http.get(`/Admin/WorkflowActivity/GetWorkflowObjectDetail?objectCode=${objectCode}&objectType=${objectType}`).then(callback);
        },
        insertFromInheritance: function (data, callback) {
            $http.post('/Admin/Contract/InsertFromInheritance', data).then(callback);
        },
        // edit prod
        ...
        getDetailJson: function (data, callback) {
            $http.get('/Admin/SendRequestWorkPrice/GetDetailJson?gAttrCode=' + data).then(callback);
        },
        // chart
        getDataBox: function (data1, data2, callback) {
            $http.get('/Admin/Contract/GetDataBox?fromDate=' + data1 + '&toDate=' + data2, {
                beforeSend: function () {
                    App.blockUI({
                        target: "#modal-body",
                        boxed: true,
        ...
        getProfitQuantityTotal: function (data1, data2, callback) {
            $http.get('/Admin/Contract/GetProfitQuantityTotal?fromDate=' + data1 + '&toDate=' + data2, {
                beforeSend: function () {
                    App.blockUI({
                        target: "#modal-body",
                        boxed: true,
        ...
        getContractQuantityTotal: function (data1, data2, callback) {
            $http.get('/Admin/Contract/GetContractQuantityTotal?fromDate=' + data1 + '&toDate=' + data2, {
                beforeSend: function () {
                    App.blockUI({
                        target: "#modal-body",
                        boxed: true,
...
app.config(function ($routeProvider, $validatorProvider, $translateProvider, $httpProvider) {
    ...
    $routeProvider
        ...
        .when('/chart', {
            templateUrl: ctxfolderContract + '/chart.html',
            controller: 'chart'
        })
        .when('/calendar', {
            templateUrl: ctxfolderContract + '/scheduleContractSaleInline.html',
            controller: 'schedule-contract-sale-inline'
        })
        .when('/editConstraintContract', {
            templateUrl: ctxfolderContract + '/editContrainst.html',
            controller: 'editContractConstraint'
        })
        .when('/viewConstraintContract', {
            templateUrl: ctxfolderContract + '/viewContrainst.html',
            controller: 'viewContractConstraint'
        })
...
app.controller('contractindex', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceContract, $window, $filter, myService, $location) {
    ...
    $scope.listWfByType = [];
    $scope.getWorkFlowByType = function () {
        dataserviceContract.getWorkFlowByType('CONTRACT', function (rs) {
            rs = rs.data;
            $scope.listWfByType = rs;
        })
    }
        ...
        .withOption('createdRow', function (row, data, dataIndex) {
            ...
            $(row).find('td:not(:has(label.mt-checkbox))').on('click', function (evt) {
                if (evt.target.localName == 'input' && evt.target.type == 'checkbox') {
                    ...
                    if ($(self).hasClass('selected')) {
                        ...
                        //$scope.selectedContractCode = '';
                    }
                    //else if (data.WfInstCode != '' && data.WfInstCode != null && data.WfInstCode != undefined) {
                    //    console.log('Already have wf');
                    //    if ($scope.chosenWf != null) {
                    //        App.toastrError('Đối tượng đã được khởi tạo hoặc gắn luồng');
                    //    }
                    //}
                    else {
            ...
            $(row).find('td:not(.listaction)').on('click', function (evt) {
                if (data.WfInstCode != '' && data.WfInstCode != null && data.WfInstCode != undefined) {
                    ...
                    console.log('WfInstCode');
                    // Thêm lớp active vào hàng đã được click
                    $(this).closest('tr').addClass('active');
                    if ($scope.chosenWf == null) {
                        if (data.WfProcessId != null && data.WfProcessId != undefined && data.WfProcessId != '0') {
                            $scope.editWorkflow(data.Code, data.WfProcessObjType, data.WfInstCode);
                        }
                        else {
                            $scope.editWorkflow(data.Code, 'CONTRACT', data.WfInstCode);
                        }
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Name').withTitle('{{"COM_TABLE_TITLE_CODE"|translate}}').notSortable().withOption('sClass', 'mnw300 fixed-column').renderWith(function (data, type, full) {
        ...
        if (full.WfInstCode != null && full.WfInstCode != undefined && full.WfInstCode != '') {
            if (full.WfProcessId != null && full.WfProcessId != undefined && full.WfProcessId != '0') {
                res1 = `<span style='color: green'>[${caption.COM_WF_BIND}]</span>`;
            }
            else {
                res1 = `<span style='color: green'>[${caption.COM_WF_CREATED}]</span>`;
            }
            try {
                var lstStatus = JSON.parse(full.JsonStatus);
        ...
        var res = `<p class="bold isEdit"><span style="color: blue">[${caption.COM_TITLE_CODE}: ${full.contractNo}]</span>${res1}<br><span>${data}</span>${res2}</p>`;
        return res;
    }));
    ...
    //    }
    //}));
    vm.dtColumns.push(DTColumnBuilder.newColumn('budgetExcludeTax').withTitle('{{"CONTRACT_CURD_COL_BUDGET_EXCLUDE_TAX"|translate}}')
        .withOption('sClass', 'tcenter ').renderWith(function (data, type, full) {
            var tax = data != "" ? $filter('currency')(data, '', 0) : null;
            return '<span class="text-danger bold">' + tax + ` ${full.currency}` + '</span>';
        }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('budget').withTitle('{{"Trước thuế - chi tiết"|translate}}')
        .withOption('sClass', 'tcenter ').renderWith(function (data, type, full) {
            var tax = data != "" ? $filter('currency')(data, '', 0) : null;
            return '<span class="text-danger bold">' + tax + ` ${full.currency}` + '</span>';
        }));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('WfInstName').withTitle('{{"Luồng việc"|translate}}').withOption('sClass', 'tcenter').renderWith(function (data, type, full) {
        if (data) {
            let actInstName = ``;
            if (full.ActInstName) {
                actInstName = `<div style="color:blue">${full.ActInstName}</div>`;
            }
            return `<div class="text-green">${data}</div>` + actInstName;
        }
        else {
            return `<a title="{{'Gán luồng'| translate}}" style="height: 25px; padding: 0px;" class="mt10 block"
                        ng-click="addWfProcessObj('${full.Code}')">
                            <i class="fa-solid fa-link fs25 "></i>
                    </a>`;
        }
    }));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('action').notSortable().withTitle('{{"CONTRACT_LIST_COL_ACTION" | translate}}').withOption('sClass', 'nowrap listaction dataTable-w80').renderWith(function (data, type, full, meta) {
        var wfbtn = '';
        if (full.WfInstCode == null || full.WfInstCode == undefined || full.WfInstCode == '') {
            if (full.WfProcessId == null || full.WfProcessId == undefined || full.WfProcessId == 0) {
                wfbtn = `<a title="{{'Tạo luồng'| translate}}" style="width: 25px; height: 25px; padding: 0px; color: #008000"
                        ng-click="createWfInstance('${full.Code}', '${full.Name}')">
            ...
            if (full.WfProcessId == null || full.WfProcessId == undefined || full.WfProcessId == 0) {
                ...
                wfbtn = `<a title="{{'Bỏ gắn luồng'| translate}}" style="width: 25px; height: 25px; padding: 0px"
                            ng-click="deleteWfProcessObj('${full.WfProcessId}')">
                                <i class="fa-solid fa-light fa-link-slash fs25 "></i>
                        </a>`;
            }
        }
        return '<a title="Sửa" ng-click="edit(' + full.id + ')" class="fs25 pr10"><i class="fas fa-edit" style="--fa-primary-color: green;"></i></a>' +
            '<a title="Xoá" ng-click="delete(' + full.id + ')"  class="fs25"><i class="fas fa-trash" style="--fa-primary-color: red;"></i></a>' + wfbtn;
    }));
    ...
    $rootScope.editConstraint = function (code) {
        dataserviceContract.getItemContract(code, function (rs) {
            rs = rs.data;
            $rootScope.ContractCode = rs.Object.ContractCode;
            $rootScope.ObjCode = rs.Object.ContractCode;
            myService.setData(data = id);
            $location.path('/editConstraintContract');
        });
    }
    ...
    $scope.chosenWf = null;
    $scope.chooseWfInstance = function () {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderWorkflowActivity + '/choose-wf-instance.html',
            controller: 'choose-wf-instance',
            backdrop: 'static',
            size: '60'
        });
        modalInstance.result.then(function (d) {
    ...
    $scope.resetWf = function () {
        $scope.chosenWf = null;
    }

    $scope.editWorkflow = function (objectCode, type, wfInstCode) {
        $scope.objectCode = objectCode;
        $scope.type = type;
    ...
    $rootScope.reloadAct = function () {
        if ($scope.tabInst && $scope.tabInst.reloadAct) {
            $scope.tabInst.reloadAct();
        }
    };

    $scope.createWfInstance = function (code, title) {
        $scope.modelWfInst = {
            WorkflowCode: "CONTRACT",
            ObjectType: "CONTRACT",
            ObjectInst: code,
            WfInstName: `Luồng hợp đồng ${title} [ ${code} ]`,
            WfDesc: "",
            WfType: "WF_TYPE_OFFICE",
            WfGroup: "WF_GROUP20201231150715"
        };
        if (code != null && code != undefined && code != "") {
            console.log(code);
            dataserviceContract.createWfInstance($scope.modelWfInst, function (rs) {
                rs = rs.data;
                if (rs.Error) {
                    ...
                    reloadData()
                    $scope.editWorkflow(code, 'CONTRACT', '');
                }
            });
        }
    }
    $scope.deleteWFIns = function (wfInstCode) {
        dataserviceContract.deleteWfInstance(wfInstCode, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            }
    ...
    $scope.selectedContractCode = '';
    $scope.addWfProcessObj = function (code) {
        $scope.selectedContractCode = code;
        if ($scope.chosenWf == null) {
            App.toastrError('Chưa chọn luồng để gán');
        }
        if ($scope.selectedContractCode === '') {
            App.toastrError(caption.COM_MSG_ERROR_OBJECT_NULL);
            return;
        }
        var listdata = $('#tblDataContract').DataTable().data();
        var userModel = {};
        for (var i = 0; i < listdata.length; i++) {
            if (listdata[i].Code == $scope.selectedContractCode) {
                userModel = listdata[i];
                break;
            }
        }
        if (userModel) {
            ...
            if (userModel.WfInstCode != '' && userModel.WfInstCode != null && userModel.WfInstCode != undefined) {
                console.log('Already have wf');
                App.toastrError('Đối tượng đã được khởi tạo hoặc gắn luồng');
                return;
            }
        ...
        var data = {
            ActInstCode: $scope.chosenWf.ActivityInstCode,
            WfInstCode: $scope.chosenWf.Code,
            ObjectType: "CONTRACT",
            ObjectInst: $scope.selectedContractCode,
            Beshare: true,
            ObjEntry: false
        };
        dataserviceContract.insertObjectProcess(data, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
    ...
    $scope.deleteWfProcessObj = function (id) {
        dataserviceContract.deleteObjectProcessingShare(id, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
...
app.controller('choose-wf-instance', function ($scope, $rootScope, $compile, $uibModal, $location, $filter, $uibModalInstance, dataserviceContract, $timeout) {
    $scope.listWfByType = [];
    $scope.getWorkFlowByType = function () {
        dataserviceContract.getWorkFlowByType('CONTRACT', function (rs) {
            rs = rs.data;
...
app.controller('contractEdit', function ($scope, $filter, $rootScope, $uibModal, $compile, dataserviceContract, myService, $location) {
    ...
    if (para != undefined) {
        $scope.initData = function () {
            ...
            dataserviceContract.getItemContract(para, function (rs) {
                ...
                $rootScope.ContractCode = $scope.model.ContractCode;
                $rootScope.ContractName = $scope.model.Title;
                setTimeout(() => $rootScope.reloadDetail(), 100);
                try {
                ...
                dataserviceContract.GetCompanyByGroup(function (rs) {
                    rs = rs.data;
                    var companyInfo = rs.Object.CountHeader;
                    var companyName = companyInfo.find(item => item.CodeSet === "Company_Name");
                    if (companyName) {
                        $scope.NameCompany = companyName.ValueSet;
                    }
                    var companyAddress = companyInfo.find(item => item.CodeSet === "Company_Address");
                    if (companyAddress) {
                        $scope.companyAddress = companyAddress.ValueSet;
                    }
                    var companytexCode = companyInfo.find(item => item.CodeSet === "Company_texCode");
                    if (companytexCode) {
                        $scope.companytexCode = companytexCode.ValueSet;
                    }

                    var companyLogo = companyInfo.find(item => item.CodeSet === "Company_logo");
                    if (companyLogo) {
                        $scope.CompanyLogo = companyLogo.ValueSet.toUpperCase();
                    }
                    console.log(rs)
                })
    ...
    $scope.print = function () {
        ...
        var department = "<table>" +
            ...
            '<p>' +
            '<img src="' + $scope.CompanyLogo + '" style="width: 100%" />' +
            '</p>' +
            "<p><strong>" + $scope.NameCompany + "</strong></p>" +
        ...
        for (var i = 0; i < $rootScope.Customers.length; i++) {
            if ($rootScope.Customers[i].Code === $scope.model.CusCode) {
                ...
                cusADd = $rootScope.Customers[i].Address;
                cusPer = $rootScope.Customers[i].PersonInCharge;
                cusRole = $rootScope.Customers[i].Role;
                break;
            }
        }
        ...
        var info = '<p style="text-align: center;">&nbsp;</p>' +
            ...
            '<h3 style="text-align: left;">&nbsp; BÊN BÁN(Bên A):' + $scope.NameCompany + '</h3>' +
            '<p style="text-align: left;">&nbsp; Địa chỉ:' + $scope.companyAddress + '</p>' +
            '<p style="text-align: left;">&nbsp; Mã số thuế: ' + $scope.companytexCode + '  </p>' +
            '<p style="text-align: left;">&nbsp; Đại diện: ................................... Chức vụ:......... </p>' +
            '<h3 style="text-align: left;">&nbsp; BÊN MUA(Bên B):' + cusName + '</h3>' +
            '<p style="text-align: left;">&nbsp; Địa chỉ:' + cusADd + ' </p>' +
            '<p style="text-align: left;">&nbsp; Mã số thuế: ' + $scope.model.CusZipCode + '  </p>' +
            '<p style="text-align: left;">&nbsp; Đại diện: ' + cusPer + ' Chức vụ:' + cusRole + '</p>' +
            '<p style="text-align: left;">&nbsp; Trên cở sở thoả thuận, hai bên thống nhất ký kết hợp đồng mua bán hàng hoá với các điều khoản sau đây: </p>' +
            '<h3 style="text-align: left;">&nbsp; Điểu 1: Tên hàng - Số lượng - Chất lượng - Giá trị hợp đồng </h3>' +
            '<p style="text-align: right;">&nbsp; Đơn vị tính: VNĐ </p>';
        ...
        var footer =
            '<p style="text-align: right;">&nbsp; Số tiền bằng chữ:<strong>' + docso(total) + ' VNĐ </p>' +
            '<h3 style="text-align: left;">&nbsp; Điểu 2: Thanh toán </h3>' +
            '<p style="text-align: left;">&nbsp;  Bên Mua phải thanh toán cho bên Bán số tiền ghi tại Điều 1 của Hợp Đồng. </p>' +
            '<h3 style="text-align: left;">&nbsp; Điểu 3: Thời gian, Địa điển và Phương thức giao hàng: </h3>' +
            '<p style="text-align: left;">&nbsp; Địa điểm giao nhận hàng:' + cusADd + '</p>' +
            '<h3 style="text-align: left;">&nbsp; Điểu 4: Trách nhiệm các bên: </h3>' +
            '<p style="text-align: left;">&nbsp; 1. Bên Bán có nhiệm vụ giao hàng đúng thời gian, địa điểm, chất lượng theo đúng quy định trong hợp đồng này, trừ trường hợp bất khả kháng.</p>' +
            '<p style="text-align: left;">&nbsp; 2. Bên Bán có nghĩa vụ cung cấp đầy đủ hoá đơn, chứng từ, tài liệu hợp lệ cho bên Mua.</p>' +
            '<p style="text-align: left;">&nbsp; 3. Bên Mua có trách nhiệm thanh toán và nhận hàng theo đúng thời gian đã quy định.</p>' +
    ...
    //inherit
    $scope.inheritDt = function () {
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: ctxfolderWorkflowActivity + '/inheritDetail.html',
            controller: 'inheritDetail',
            backdrop: 'static',
            size: '50',
            //resolve: {
            //    para: function () {
        ...
        modalInstance.result.then(function (d) {
            console.log(d);
            $rootScope.listDetail = d;
            $rootScope.listDetail.forEach(x => x.HeaderCode = $rootScope.ContractCode);
            $rootScope.isInherit = true;
            //$scope.initLoad();
        }, function () {
        });
    }
    $scope.saveAll = function () {
        dataserviceContract.insertFromInheritance($rootScope.listDetail, function (result) {
            result = result.data;
            if (result.Error) {
                App.toastrError(result.Title);
            } else {
...
app.controller('inheritDetail', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceContract, $location, $uibModalInstance) {
    ...
    $scope.lstDt = [];
    $scope.initLoad = function () {
        dataserviceContract.getWorkflowObjectAct($rootScope.ContractCode, $rootScope.ObjectType, function (rs) {
            rs = rs.data;
            $scope.listObjWfDt = rs;
        });
    }
    ...
    $scope.validate = async function () {
        var result = false;
        if ($scope.model.ObjectId != '' && $scope.model.ObjectId != null && $scope.model.ObjectId != undefined) {
            result = false;
        } else {
            App.toastrError(caption.WFAI_MSG_PLS_SELECT_OBJECT);
            return true;
        }
        var isObjValid = await checkWorkflowObjectHeader();
        if (!isObjValid) {
            App.toastrError(caption.WFAI_MSG_INVALID_OBJ);
            return true;
        }
        return result;
    }
    function checkWorkflowObjectHeader() {
        return new Promise((resolve) => {
            dataserviceContract.checkWorkflowObjectHeader($scope.model.ObjectCode, $scope.model.ObjectType, function (rs) {
                rs = rs.data;
                resolve(rs);
            });
        });
    ...
    $scope.changleSelect = async function (type, item) {
        $scope.model.ObjectType = item.ObjectType;
        $scope.model.ObjectCode = item.ObjectCode;
        var isObjValid = await checkWorkflowObjectHeader();
        if (!isObjValid) {
            App.toastrError(caption.WFAI_MSG_INVALID_OBJ);
        }
    ...
    $scope.inheritDt = async function () {
        const isInvalid = await $scope.validate();
        if (!isInvalid) {
            dataserviceContract.getWorkflowObjectDetail($scope.model.ObjectCode, $scope.model.ObjectType, function (rs) {
                rs = rs.data;
                $scope.lstDt = rs;
            })
        }
    ...
    $scope.submit = function () {
        if ($scope.lstDt.length > 0) {
            $uibModalInstance.close($scope.lstDt);
        }
        else {
            App.toastrError(caption.WFAI_MSG_NO_DETAIL_INHERITED);
        }
    }
...
app.controller('editContractConstraint', function ($scope, $filter, $rootScope, $uibModal, $compile, dataserviceContract, myService, $location, $controller) {
    $controller('edit', { $scope: $scope, $rootScope: $rootScope });
    $rootScope.modelConstraint = {
        WorkflowCat: true,
        Title: true,
        ContractCode: true,
        PrjCode: true,
        ...
        Duration: true,
        sEndDate: true,
        BudgetExcludeTax: true,
        TaxAmount: true,
        BudgetTotalInput: true,
        Version: true,
        AcceptanceTime: true,
        Maintenance: true,
        StatusTemp: true,
    ...
    $rootScope.haveConstraint = true;
    $rootScope.viewConstraint = false;

    var url_string = window.location.href.replace(/#/g, '');

    var url = new URL(url_string);
    console.log(url);
    const para = url.searchParams.get("id");
    const id = url.searchParams.get("constraintId");
    console.log(id);
    $rootScope.constraintId = id;
    ...
    if (para != undefined) {
        $scope.initData = function () {
            ...
            dataserviceContract.getObjectActivityInstanceNote(id, function (rs) {
                rs = rs.data;
                try {
                    const obj = JSON.parse(rs.ObjectJsonConstraintView);
                    if (obj) {
                        $rootScope.modelConstraint = obj;
                    }
                    const objData = JSON.parse(rs.ObjectJsonData);
                    console.log(objData)

                    if (objData) {
                        setTimeout(() => {
                            $rootScope.viewConstraint = true;
                            $rootScope.haveConstraint = false;
                            $scope.model = objData;
                        }, 500);
                    }
                } catch (e) {
    ...
    $scope.submitConstraint = function () {
        ...
        /*if ($scope.editContrainstform.validate() && !validationSelect($scope.model).Status) {*/
        const model = $scope.model;
        model.ListProduct = $rootScope.listAllDetail;
        console.log(model);
        const body = {
            Id: $rootScope.constraintId,
            //ActivityInstCode: $rootScope.ActivityInstCode,
            //ObjectType: "REQUEST_PRICE",
            //ObjectCode: $rootScope.RequestCode,
            ObjectJsonConstraintView: JSON.stringify($rootScope.modelConstraint),
            //ObjectJsonData: JSON.stringify(model),
            //ActivityInstShare: $rootScope.ActivityInstShare,
        };
        var modalInstance = $uibModal.open({
            templateUrl: ctxfolderMessage + '/messageConfirmUpdate.html',
            resolve: {
            ...
            controller: function ($scope, $uibModalInstance, para) {
                $scope.message = caption.COM_MSG_EDIT_CONFIRM.replace("{0}", "");//"Bạn có chắc chắn muốn thay đổi ?";
                $scope.ok = function () {
                    dataserviceContract.updateObjectActivityInstanceView(body, function (result) {
                        result = result.data;
                        if (result.Error) {
                            App.toastrError(result.Title);
                        } else {
...
app.controller('viewContractConstraint', function ($scope, $filter, $rootScope, $compile, $uibModal, dataserviceContract, myService, $location, $controller) {
    $controller('edit', { $scope: $scope, $rootScope: $rootScope });
    $rootScope.modelConstraint = {
        ReqCode: true,
        WorkflowCat: true,
        ...
        StatusObject: true,
        UserRequest: true,
        STimeTicketCreate: true,
        CusCode: true,
        CusAddress: true,
        CusZipCode: true,
        CusMobilePhone: true,
        CusPersonInCharge: true,
        CusEmail: true,
    };
    $rootScope.haveConstraint = true;
    $rootScope.viewConstraint = false;
    ...
    const para = url.searchParams.get("id");
    const id = url.searchParams.get("constraintId");
    const actInstCode = url.searchParams.get("actInstCode");
    console.log(id);
    $rootScope.constraintId = id;
    //var para = myService.getData();
    if (para == undefined) {
    ...
    function getPermission(code) {
        return new Promise((resolve) => {
            dataserviceContract.checkPermissionEditActivity(code, function (rs) {
                rs = rs.data;
                resolve(rs);
            });
        });
    }
    $scope.submitViewConstraint = function () {
        const permission = getPermission(actInstCode);
        console.log(permission);
        if (!permission && !isAllData) {
            App.toastrError("Bạn không có quyền ghi đè đối tượng này");
            return;
        }
        validationSelect($scope.model);
        if (!validationSelect($scope.model).Status) {
            const model = $scope.model;
            model.ListProduct = $rootScope.listDetail;
            console.log(model);
            const body = {
                Id: $rootScope.constraintId,
                ObjectJsonData: JSON.stringify(model),
            ...
            var modalInstance = $uibModal.open({
                ...
                controller: function ($scope, $uibModalInstance, para) {
                    $scope.message = caption.COM_MSG_EDIT_CONFIRM.replace("{0}", "");//"Bạn có chắc chắn muốn thay đổi ?";
                    $scope.ok = function () {
                        dataserviceContract.updateObjectActivityInstanceNote(body, function (result) {
                            result = result.data;
                            if (result.Error) {
                                App.toastrError(result.Title);
                            } else {
    ...
    $scope.openLog = function () {
        dataserviceContract.getUpdateLog($scope.model.ReqCode, function (rs) {
            rs = rs.data;
            var modalInstance = $uibModal.open({
                animation: true,
...
app.controller('contractTabSchedulePay', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceContract, $filter) {
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Money').withTitle('{{"CONTRACT_LBL_THE_VALUE_OF_MONEY" | translate}}').renderWith(function (data, type) {
        var money = data != "" ? $filter('currency')(data, '', 0) : 0;
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('PaidMoney').withTitle('{{"CONTRACT_LBL_PAID_MONEY" | translate}}').renderWith(function (data, type) {
        var money = data != "" ? $filter('currency')(data, '', 0) : 0;
        return '<span class="bold text-danger">' + money + '</span>';
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('PaidTime').withTitle('{{"CONTRACT_LBL_PAID_TIME" | translate}}').renderWith(function (data, type) {
        return data != null && data != "" ? $filter('date')(new Date(data), 'dd/MM/yyyy') : null;
    }));
        ...
        if ($scope.addform.validate() && validationSelect($scope.model).Status == false) {
            ...
            dataserviceContract.insertContractSchedulePay($scope.model, function (rs) {
                ...
                if (rs.Error) {
                    ...
                    $scope.reload();
                    App.toastrSuccess(rs.Title);
                    $scope.model.PayTimes = Number($scope.model.PayTimes) + 1;
                    //$uibModalInstance.close(rs.Object);
                }
            })
        }
    ...
    $scope.edit = function (id) {
        ...
        for (var i = 0; i < listdata.length; ++i) {
            if (listdata[i].Id == id) {
                ...
                $scope.model.PaidMoney = item.PaidMoney;
                $scope.model.EstimateTime = item.EstimateTime;
                $scope.model.PaidTime = item.PaidTime;

                $scope.model.sEstimateTime = ($scope.model.EstimateTime != null ? $filter('date')(new Date($scope.model.EstimateTime), 'dd/MM/yyyy') : "");

                if ($scope.model.PaidTime) {
                    $scope.model.sPaidTime = ($scope.model.PaidTime != null ? $filter('date')(new Date($scope.model.PaidTime), 'dd/MM/yyyy') : "");
                }
...
//tab product
app.controller('contractTabProduct', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceContract, dataserviceMaterial, $filter) {
    var vm = $scope;
    //$scope.selected = [];
    //$scope.selectAll = false;
    //$scope.toggleAll = toggleAll;
    ...
    $scope.fnPageList = function (page) {
        var intBegin = (page - 1) * $scope.modelTable.pageLength;
        $scope.modelTable.intBegin = intBegin;
        $scope.modelTable.intSkip = intBegin + $scope.modelTable.pageLength;
        $scope.listDetail = $scope.listAllDetail.slice($scope.modelTable.intBegin, $scope.modelTable.intSkip);
    }
    function getAllDetail() {
        $scope.pageList = [];
        $scope.listDetail = [];
        $scope.listExtraColumn = [];
        dataserviceContract.getAllDetail($rootScope.ContractCode, function (rs) {
            rs = rs.data;
            $scope.listAllDetail = rs;
            for (var i = 0; i < $scope.listAllDetail.length; i++) {
                const detail = $scope.listAllDetail[i];
                console.log(detail.GattrJson);
                try {
                    gattrJson = JSON.parse(detail.GattrJson);
                    const listProductAttributes = gattrJson.ListProductAttributes ?? [];
                    detail.Attr = {};
                    for (var j = 0; j < listProductAttributes.length; j++) {
                        const code = listProductAttributes[j].AttrCode;
                        const check = $scope.listExtraColumn.find(x => x.AttrCode === code);
                        if (check == null) {
                            $scope.listExtraColumn.push(listProductAttributes[j]);
                        }
                        detail.Attr[code] = listProductAttributes[j].AttrValue;
                    }
                    detail.TaxMoney = ((detail.Quantity * (detail.UnitPrice ?? 0)) * (detail.Tax ?? 0)) / 100;
                    detail.TotalPrice = detail.Quantity * (detail.UnitPrice ?? 0);
                    detail.TotalAfterTax = detail.Quantity * (detail.UnitPrice ?? 0) + (detail.Quantity * (detail.UnitPrice ?? 0)) * (detail.Tax ?? 0) / 100;
                } catch (e) {
                    console.log(e);
                }
            }
            const totalPage = Math.ceil($scope.listAllDetail.length / $scope.modelTable.pageLength);
            for (let i = 1; i <= totalPage; i++) {
                $scope.pageList.push(i);
                $scope.listDetail = $scope.listAllDetail.slice(0, $scope.modelTable.pageLength);
            }
        });
    }
    ...
    $scope.add = function () {
        var obj = {
            ...
            GattrFlatCode: $scope.model.GattrFlatCode,
            ProdCustomJson: $scope.model.ProdCustomJson,
    ...
    $scope.edit = function (item) {
        ...
        $scope.model.ProductId = item.ProductId;
        $scope.model.GattrCode = item.GattrCode;
        $scope.calTax();
    }
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
    ...
    $scope.editProd = function () {
        var id = $scope.model.ProductId;
        var gattrCode = $scope.model.GattrCode;
        dataserviceMaterial.getItem(id, function (rs) {
            ...
            if (rs.Error) {
                ...
                modalInstance.result.then(function (d) {
                    ...
                    $scope.model.ProdCustomJson = JSON.stringify(obj, null, 2);
                    $scope.model.GattrFlatCode = gattrFlatCode;
                    if ($scope.isAdd == false) {
                        $scope.model.ContractCode = $rootScope.ContractCode;
                        dataserviceContract.updateGattrJson($scope.model, function (rs) {
                            rs = rs.data;
                            if (rs.Error) {
                                App.toastrError(rs.Title);
                            }
                                ...
                                App.toastrSuccess(rs.Title);
                                $rootScope.reloadDetail();
                                $scope.model.GattrCode = rs.Object;
                            }
                        });
                    }
                }, function () {
...
//tab product
app.controller('contractTabProductInherit', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceContract, $filter, $q) {
    var vm = $scope;
    $scope.selected = [];
    $scope.selectAll = false;
    $scope.toggleAll = toggleAll;
    ...
    var getTableData = function () {
        ...
        deferred.resolve($rootScope.listDetail ?? []);
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('ItemCode').withTitle('{{"CONTRACT_TAB_LOP_LIST_COL_PRODUCT_CODE" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    vm.dtColumns.push(DTColumnBuilder.newColumn('Price').withTitle('{{"CONTRACT_TAB_LOP_LIST_COL_UNIT_PRICE" | translate}}').renderWith(function (data, type) {
        var dt = data ? $filter('currency')(data, '', 0) : '';
        return '<span class= "text-danger bold">' + dt + '</span>';
    }));
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('UnitName').withTitle('{{"CONTRACT_TAB_LOP_LIST_COL_S_UNIT" | translate}}').renderWith(function (data, type) {
        return data;
    }));
    ...
    $scope.add = function () {
        var obj = {
            Id: $rootScope.listDetail.length + 1,
            HeaderCode: $rootScope.ContractCode,
            ItemCode: $scope.model.ProductCode,
            ProductType: $scope.productType,
            Quantity: $scope.model.Quantity,
            Cost: $scope.model.UnitPrice,
            Price: $scope.model.UnitPrice,
            Unit: $scope.model.Unit,
            UnitName: $scope.units.find(x => x.Code == $scope.model.Unit)?.Name ?? "",
            Tax: ($scope.model.Tax == null || $scope.model.Tax == '') ? 0 : $scope.model.Tax,
            Note: $scope.model.Note,
            PriceType: $scope.model.PriceOption,
            PackJson: $scope.packJson,
    ...
    $scope.edit = function (id) {
        ...
        for (var i = 0; i < listdata.length; ++i) {
            if (listdata[i].Id == id) {
                var item = listdata[i];
                $scope.model.ProductCode = item.ItemCode;
                $scope.model.Quantity = item.Quantity;
                $scope.model.UnitPrice = item.Cost;
    ...
    $scope.delete = function (id) {
        var modalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                $scope.message = caption.COM_MSG_DELETE_CONFIRM_COM;//"Bạn có chắc chắn muốn xóa?";
                $scope.ok = function () {
                    const index = $rootScope.listDetail.findIndex(x => x.Id == id);
                    if (index != -1) {
    ...
    $scope.save = function (id) {
        ...
        //    return;
        //}
        var md = $rootScope.listDetail.find(x => x.Id == $scope.editId);
        md.ContractCode = $rootScope.ContractCode;
        md.ProductCode = $scope.model.ProductCode;
        md.Quantity = $scope.model.Quantity;
        md.Cost = $scope.model.UnitPrice;
        md.Price = $scope.model.UnitPrice;
        md.Unit = $scope.model.Unit;
        md.UnitName = $scope.units.find(x => x.Code == $scope.model.Unit)?.Name ?? "";
        md.Tax = $scope.model.Tax;
        md.Note = $scope.model.Note;
        md.Price = $scope.model.Price;
...
app.controller('editProdCustom', function ($scope, $rootScope, $compile, $controller, $uibModal, $uibModalInstance, dataserviceMaterial, dataserviceContract, para) {
    $scope.isCustom = true;
    $controller('editProd', { $scope: $scope, para: para, $uibModalInstance: $uibModalInstance });
    $scope.header = "Xem tùy chỉnh thiết bị";
    $scope.originModel = angular.copy($scope.model);
    $scope.prodCustomJson = para.ProdCustomJson;
    $scope.gattrCode = para.GattrCode;
    ...
    $scope.initDataProd = function () {
        if (!$rootScope.isReturn && $scope.gattrCode) {
            dataserviceContract.getDetailJson($scope.gattrCode, function (rs) {
                rs = rs.data;
                console.log(rs);
                ...
                if (rs) {
                    ...
                    dataserviceContract.getListAttribute({ ProductCode: $scope.model.ProductCode }, function (rs) {
                        rs = rs.data;
                        if (!$rootScope.listProductAttributes || $rootScope.listProductAttributes.length === 0) {
                            $rootScope.listProductAttributes = rs.data;
                        }
                        $rootScope.listProductAttributes.forEach((x, i) => {
                            x.Id = i
                        });
                    ...
                    dataserviceContract.getListComponent({ ProductCode: $scope.model.ProductCode }, function (rs) {
                        rs = rs.data;
    ...
    $scope.selectProduct = function (item) {
        if ($rootScope.isReturn) {
            ...
            dataserviceContract.getMappingJson(item.Id, function (rs) {
                rs = rs.data;
                console.log(rs);
                let isComponentIn = false;
                if (rs) {
...
app.controller('tabAttributeImport', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceMaterial, dataserviceContract, $filter, $q) {
    var vm = $scope;
    $scope.selected = [];
    $scope.selectAll = false;
    $scope.toggleAll = toggleAll;
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('AttrCode').withTitle('{{"MLP_LIST_COL_ATTRIBUTE_CODE" | translate}}').renderWith(function (data, type, full) {
        var keyExists = $scope.listKeyValue.some(function (item) {
            return item.key === data;
        });
        if (!keyExists) {
            $scope.listKeyValue.push({ key: data, value: full.AttrValue });
        } else {
            const obj = $scope.listKeyValue.find(x => x.key === data);
            obj.value = full.AttrValue;
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('Formula').withTitle('{{"Biểu thức" | translate}}').renderWith(function (data, type) {
        return '<label><span>' + data + '</span></label>';
    }));
    ...
    vm.reloadData = reloadData;
    vm.dtInstance = {};
    $scope.calculateFormulaJson = function () {
        var data = {
            ListFormula: $rootScope.listProductAttributes
        };
        dataserviceMaterial.calculateFormula(data, function (rs) {
            rs = rs.data;
            ...
            if (rs.Error) {
                ...
                console.log(rs);
                App.toastrSuccess(rs.Title);
                const value = rs.Object;
                value.forEach(z => {
                    const attr = $rootScope.listProductAttributes.find(x => x.AttrCode === z.AttrCode);
                    if (attr) {
                        attr.AttrValue = z.AttrValue;
                    }
                });
                $rootScope.reloadAttribute();
            }
    ...
    $scope.init = function () {
        ...
        if (!$rootScope.isReturn) {
            dataserviceContract.getListAttribute({ ProductCode: $rootScope.ProductCode }, function (rs) {
                rs = rs.data;
                if (!$rootScope.listProductAttributes || $rootScope.listProductAttributes.length === 0) {
                    $rootScope.listProductAttributes = rs.data;
                }
    ...
    $scope.changeAttr = function (item) {
        $scope.model.AttrName = item.Name;
    }
    ...
    $scope.add = function () {
        ...
        if ($scope.addform.validate() && validationSelect($scope.model).Status == false) {
            ...
            $rootScope.listProductAttributes.push({
                AttrCode: $scope.model.AttrCode,
                AttrName: $scope.model.AttrName,
                AttrValue: $scope.model.AttrValue,
                Id: id,
                ProductCode: $scope.model.ProductCode
            });
    ...
    $scope.edit = function (id) {
        ...
        if ($scope.indexObject !== -1) {
            ...
            const attr = $scope.listProductAttributeMain.find(x => x.Code == $scope.model.AttrCode);
            $scope.model.AttrName = attr?.Name ?? "";
...
app.controller('tabComponentImport', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceMaterial, dataserviceContract, $filter, $q) {
    var vm = $scope;
    $scope.selected = [];
    $scope.selectAll = false;
    $scope.toggleAll = toggleAll;
    ...
    $scope.init = function () {
        ...
        if (!$rootScope.isReturn) {
            dataserviceContract.getListComponent({ ProductCode: $rootScope.ProductCode }, function (rs) {
                rs = rs.data;
                $rootScope.ListProductComponents = $rootScope.ListProductComponents.concat(rs.data);
                $rootScope.ListProductComponents.forEach((x, i) => {
                    x.Id = i
...
app.controller('addProduct', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceContract, dataserviceMaterial, $filter) {
    var vm = $scope;
    var id = -1;
    $scope.selected = [];
    $scope.selectAll = false;
...
app.controller('schedule-contract-sale-inline', function ($scope, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModal, $filter, dataserviceContract) {
    $scope.model = {
        MemberId: '',
        FromDate: '',
        ToDate: ''
...
app.controller('grid-view-calendar', function ($scope, $rootScope, $compile, DTOptionsBuilder, DTColumnBuilder, DTInstances, $uibModal, $uibModalInstance, $filter, dataserviceContract, para) {
    ...
    vm.dtOptions = DTOptionsBuilder.newOptions()
        .withOption('ajax', {
            ...
            complete: function () {
                App.unblockUI("#contentMain");
                heightTableManual(450, "#tblDataContractCalendar");
            }
        })
        .withPaginationType('full_numbers').withDOM("<'table-scrollable't>ip")
        .withDataProp('data').withDisplayLength(pageLength)
    ...
    vm.dtColumns.push(DTColumnBuilder.newColumn('cusName').withTitle('{{"CONTRACT_CURD_COL_CUSNAME"|translate}}').notSortable().withOption('sClass', 'w300 fixed-column').renderWith(function (data, type, full) {
        const contractNo = `<p>{{'CONTRACT_CURD_COL_CONTACT_NO' | translate}}: ${full.contractNo}</p>`;
        return data + contractNo;
    }));
    //vm.dtColumns.push(DTColumnBuilder.newColumn('contractNo').withTitle('{{"CONTRACT_CURD_COL_CONTACT_NO"|translate}}').notSortable().withOption('sClass', 'fixed-column').renderWith(function (data, type) {
    //    return data;
    //}));
    vm.dtColumns.push(DTColumnBuilder.newColumn('sEndDate').withTitle('{{"CONTRACT_CURD_COL_S_END_DATE"|translate}}').withOption('sClass', 'tcenter').renderWith(function (data, type) {
        var deadLine = '';
    ...
    $scope.exportExcel = function () {
        ...
        dataserviceContract.exportExcelCalendar(body, function (rs) {
            rs = rs.data;
            //App.unblockUI("#contentMain");
...
app.controller('chart', function ($scope, $rootScope, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTInstances, dataserviceContract, $filter, $timeout) {
            ...
            tooltips: {
                callbacks: {
                    label: function (tooltipItem, data) {
                        var label = '';
                        if (type === 'import') {
                            label = `${serieImport[tooltipItem.datasetIndex]}: ${tooltipItem.yLabel.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}`;
                        }
                        if (type === 'export') {
                            label = `${serieExport[tooltipItem.datasetIndex]}: ${tooltipItem.yLabel.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}`;
                        }
                        return [label];
                    }
                },
    ...
    $scope.importTotal = {
        ...
        data: totalImport,
        serie: serieImport,
        option: optionImportExport('import')
    };
    $scope.exportTotal = {
        labels: labelImport,
        data: totalImport,
        serie: serieImport,
        option: optionImportExport('export')
    };

    //1. Tìm kiếm màn index
    $scope.searchAll = function () {
        ...
        dataserviceContract.getProfitQuantityTotal($scope.model.FromDate, $scope.model.ToDate, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
                dataImport = rs.Object;
                serieImport = dataImport.Series.map(x => x.SerieName);
                labelImport = dataImport.Labels.map(x => x);
                totalImport = dataImport.Series.map(x => x.SerieData.map(y => y.Total));
                $scope.importTotal.serie = serieImport;
                $scope.importTotal.labels = labelImport;
                $scope.importTotal.data = totalImport;
                console.log($scope.importTotal);
            }
        });

        dataserviceContract.getContractQuantityTotal($scope.model.FromDate, $scope.model.ToDate, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
                dataExport = rs.Object;
                serieExport = dataExport.Series.map(x => x.SerieName);
                labelExport = dataExport.Labels.map(x => x);
                totalExport = dataExport.Series.map(x => x.SerieData.map(y => y.Total));
                $scope.exportTotal.serie = serieExport;
                $scope.exportTotal.labels = labelExport;
                $scope.exportTotal.data = totalExport;
                console.log($scope.exportTotal);
                console.log('importTotal', $scope.importTotal)
            }
        });

        dataserviceContract.getDataBox($scope.model.FromDate, $scope.model.ToDate, function (rs) {
            rs = rs.data;
            if (rs.Error) {
                App.toastrError(rs.Title);
            } else {
                $scope.dataBox = rs.Object;
                console.log(dataBox.Profit.Total);
                console.log(dataBox.Profit.Collected);
                console.log(dataBox.Profit.Work);
                console.log(dataBox.ContractNum.Total);
                console.log(dataBox.ContractNum.Completed);
                console.log(dataBox.ContractNum.Pending);
                console.log(dataBox.Fund.Receipt);
                console.log(dataBox.Fund.Expense);
                console.log(dataBox.Fund.PaperMoney);
                console.log(dataBox.Fund.BankMoney);
...
let serieImport = dataImport.Series.map(x => x.SerieName);
let labelImport = dataImport.Labels.map(x => x);
let totalImport = dataImport.Series.map(x => x.SerieData.map(y => y.Total));
let dataExport = {
    "Series": [
        {
            "SerieName": "Không xác định",
            "SerieData": [
                {
                    "Total": 0,
                    "StatusCode": null,
...
let serieExport = dataExport.Series.map(x => x.SerieName);
let labelExport = dataExport.Labels.map(x => x);
let totalExport = dataExport.Series.map(x => x.SerieData.map(y => y.Total));
let dataBox = {
    "Profit": {
        "Total": 138182800,
        "Collected": 5000000,
